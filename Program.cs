...
namespace nim
{
    class Program
    {
        ...
        public void inicio()
        {
            ...
            Console.WriteLine(" \n\n[Jugadores] =  2 \n[Objetivo] = Intentar quitar los últimos palitos de la Consola \n[Jugando]\n * Se dispone de 16 palitos en la Consola \n * Al inicio el jugador quita 1 o 2 palitos de la Consola. \n * Cuando el jugador quita 1 o 2 palitos termina su turno \n * Gana el jugador que saca los ultimos palitos \n * Tiene un tiempo Disponible de 7 segundos por Turno");
            Console.SetCursorPosition(1, 25);
            Console.ForegroundColor = ConsoleColor.White;
            Console.WriteLine("by Luis Alfredo Suárez Litardo \n Telemática 3er Semestre \n Materia: Árboles y Teória de Juegos \n Profesor: Ing.Marcillo Vera");
        }
